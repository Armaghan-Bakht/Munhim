      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 w-full relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-900 tracking-tight leading-[1.1] mb-6">
            Scaling Mobile Apps with Data-Driven <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-400">Marketing</span>
          </h1>
          
          <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-lg leading-relaxed">
            Digital Marketing Expert specializing in Google Ads, App Growth & Monetization. We turn data into revenue.
          </p>
        ...
        >
          ...
          <div className="absolute inset-0 bg-white rounded-3xl shadow-xl border border-slate-100 flex flex-col items-center justify-center p-8 backdrop-blur-xl bg-white/80">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-2">Growth Dashboard</h3>
            <p className="text-slate-500 text-center">Optimizing Campaigns & Driving ROAS</p>
          </div>
          ...
          >
            ...
            <p className="text-sm font-semibold text-slate-600 mt-1">Apps Scaled</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm font-semibold text-slate-600 mt-1">Conversion Boost</p>
          </motion.div>
        </motion.div>
